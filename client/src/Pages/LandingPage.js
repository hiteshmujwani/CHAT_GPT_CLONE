    ...
    <>
      <div className="h-screen bg-gray-900 flex justify-center items-center text-white">
        <div className="flex flex-col gap-5 items-center text-center">
          ...
          <div className="welcome-lines flex flex-col gap-2">
            <h1 className="text-6xl">Welcome to MyAI</h1>
            <h4 className="text-2xl">Your Ultimate AI Assistant</h4>
          </div>
          <div className="flex gap-5">
            <Link
              to={"/login"}
              className="border bg-gray-700 px-8 py-3 text-xl"
            >
              Login
            </Link>
            <Link
              to={"/register"}
              className="border px-8 py-3 bg-gray-700 text-xl"
            >
              Sign Up
            </Link>
          </div>
