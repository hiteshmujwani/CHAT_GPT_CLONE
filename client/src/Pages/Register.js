  ...
  return (
    <div className="flex justify-center items-center h-screen bg-gray-900 text-white">
      <div className="flex flex-col gap-5 items-center">
        ...
        <div className="login-heading text-5xl">Create Your Account</div>
        <div className="Login-form flex flex-col gap-3 w-full text-black">
          <input
            className="border-black border-2 py-2 px-4 font-bold outline-none"
            type="text"
          ...
          />
          <input
            className="border-black border-2 outline-none py-2 px-4 font-bold"
            type="email"
            placeholder="Email"
          ...
          />
          <input
            className="border-black border-2 py-2 px-4 outline-none font-bold"
            type="password"
        ...
        <button
          ...
          className="submit text-xl bg-green-600 text-white w-full py-2"
        >
          Continue
        </button>
        <p>
